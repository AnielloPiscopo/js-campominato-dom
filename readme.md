...
| File                                                                                      | Summary                   |
| ---                                                                                       | ---                       |
| [index.html](https://github.com/AnielloPiscopo/js-campominato-dom/blob/main/index.html)   | HTTPStatus Exception: 429 |
| [style.css](https://github.com/AnielloPiscopo/js-campominato-dom/blob/main/css\style.css) | HTTPStatus Exception: 429 |
| [script.js](https://github.com/AnielloPiscopo/js-campominato-dom/blob/main/js\script.js)  | HTTPStatus Exception: 429 |
...
1. Clone the js-campominato-dom repository:
```sh
